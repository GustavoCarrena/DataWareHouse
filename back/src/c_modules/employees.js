...
router.put('/updateEmployeesData',employeesMiddlewares.authenticateJWT,employeesMiddlewares.authenticateRole,employeesMiddlewares.updateDataFillValidate,employeesMiddlewares.duplicateEmail,employees.updateEmployeesData);
router.delete('/deleteEmployeesData',employeesMiddlewares.authenticateJWT,employeesMiddlewares.authenticateRole, employees.deleteEmployeesData);

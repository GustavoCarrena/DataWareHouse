...
router.put('/updateChannel', employeesMiddlewares.authenticateJWT, contactChannel.updateChannel);
router.delete('/deleteChannel', employeesMiddlewares.authenticateJWT, contactChannel.deleteChannel);
